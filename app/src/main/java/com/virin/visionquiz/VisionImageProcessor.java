...
public interface VisionImageProcessor {
  ...
  /** Processes a bitmap image and invokes the callback when processing finishes. */
  void processBitmap(Bitmap bitmap, GraphicOverlay graphicOverlay, Runnable onComplete);
