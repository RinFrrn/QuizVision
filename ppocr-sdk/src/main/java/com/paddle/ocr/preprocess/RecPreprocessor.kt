...
// Modified by QuizVision in 2026 to honor the bundled model's BGR input metadata.
//
...
object RecPreprocessor {
    ...
    fun preprocessBatch(crops: List<Mat>): RecPreprocessResult {
        // Detection and cropping keep OpenCV's BGR channel order. The bundled model's
        // inference.yml also declares DecodeImage.img_mode=BGR, so preserve that order here.
